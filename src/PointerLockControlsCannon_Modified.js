 ...
 */
class PointerLockControlsCannon_Modified extends THREE.EventDispatcher {
  ...
  onPointerlockError = () => {
    console.error('PointerLockControlsCannon_Modified: Unable to use Pointer Lock API')
  }
...
export { PointerLockControlsCannon_Modified }
